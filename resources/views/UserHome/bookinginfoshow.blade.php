							...
							<div class="well col-lg-12">
								<table align="center">
									...
									<tr>
										...
										<td class="right">{{$bkngId->rentalType}}</td>
									</tr>
									<tr>
										<td class="left">Package Type :</td>
										<td class="right">{{$bkngId->packageType}}</td>
									</tr>
									<tr>
										<td class="left">Vehicle Type :</td>
										<td class="right">{{$bkngId->vehicleType}}</td>
									</tr>
									<tr>
										<td class="left">Price :</td>
										<td class="right">{{$bkngId->price}}</td>
									</tr>
									<tr>
									...
									<tr>
									<td class="left">
										<a href="/bookinginfo/{{$bkngId->bookId}}/edit"><button type="button" class="btn btn-primary pull-right">Edit</button></a>
									</td>
									<td class="right">
