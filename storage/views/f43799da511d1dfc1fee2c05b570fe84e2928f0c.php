				...
				<div class="row">
					<div class="col-lg-9" style="left: 50%;transform: translate(-50%);">
						<div class="row hcr-card hcr-right">
							<h3 class="text-center">AC Sedan Car </h3>
							<span style="padding-left: 10px; padding-right: 10px; font-size: 20px;" class="text-center">Zone#2: Banani, Gulshan, Niketon, Baridhara, All DOHS, Bashundhora, Dhaka Cantonment, Mirpur, Pallabi, Agargaon,Panthapath, Elephant Rd, Dhanmondi, Zigatola, Mohammadpur, Lalmatia, Farmgate, Badda.</span>
							<hr>
							<div class="col-lg-12" style="border-bottom: 1px solid #bc3633; padding-bottom: 20px;">
								<div class="col-lg-4">
									<img src="/images/at2.png" class="img-responsive" alt="Image" style="margin: 10px auto 0 auto;">
								</div>
								<div class="col-lg-4 text-center">
									<span>৳ 1500</span>
									<a href="/user/booking.html"><button type="button" class="btn btn-primary">BOOK NOW</button></a>
								</div>
								<div class="col-lg-4">
									<img src="/images/at2.png" class="img-responsive flip" alt="Image" style="margin: 10px auto 0 auto;">
								</div>
							</div>
							<div class="col-lg-12">
								<ul class="text-justify">
									<li>This rate is for only one way transfer. (to or from Hazrat Shah Jalal International Airport)</li>
									<li>For round trip additional BDT 500 will be added.</li>
									...
									<li>Standard AC Car: Axio, Fielder, Allion, Premio, X Corolla (Depends on availability)</li>
