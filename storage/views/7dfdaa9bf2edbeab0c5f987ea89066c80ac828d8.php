					...
					<div class="col-lg-12">
						<div class="row booking-card">
							<div class="col-lg-6">
								...
								<input type="text" name="firstName" id="input" class="form-control" value="<?php echo e($userId->firstName); ?>">
							</div>
							<div class="col-lg-6">
								<p style="font-size: 16px; font-family: tm;">LAST NAME:</p>
								<input type="text" name="lastName" id="input" class="form-control" value="<?php echo e($userId->lastName); ?>">
							</div>
							<div class="col-lg-6">
							...
							<div class="col-lg-6">
								...
								<input type="text" name="phone"  id="input" class="form-control" value="<?php echo e($userId->phone); ?>">
							</div>
							<div class="col-lg-6">
								<p style="font-size: 16px; font-family: tm; margin-top: 20px;">Date Of Birth:</p>
								<input type="date" name="dob"  id="input" class="form-control" value="<?php echo e($userId->dob); ?>">
							</div>
