								...
								<div class="col-lg-7">
									<table align="">
										<tr>
											...
											<td class="right"><input type="text" readonly="readonly" name="packageId" value="<?php echo e($pcklist->packageId); ?>"></td>
										</tr>
										<tr>
											<td class="left">Package Name :</td>
											<td class="right"><input type="text" readonly="readonly"  name="packageName" value="<?php echo e($pcklist->rentalType); ?>"></td>
										</tr>
										<tr>
											<td class="left">Package Type :</td>
											<td class="right"><input type="text" readonly="readonly"  name="packageType" value="<?php echo e($pcklist->packageType); ?>"></td>
										</tr>
										<tr>
											<td class="left">Vehicle Type :</td>
											<td class="right"><input type="text" readonly="readonly"  name="vehicleType" value="<?php echo e($pcklist->vehicleType); ?>"></td>
										</tr>
										<tr>
											<td class="left">Location :</td>
											<td class="right"><input type="text" readonly="readonly"  name="location" value="<?php echo e($pcklist->location); ?>"></td>
										</tr>
										<tr>
											<td class="left">Price :</td>
											<td class="right"><input type="text" readonly="readonly"  name="price" value="<?php echo e($pcklist->price); ?>"></td>
										</tr>
										
										<tr>
											<td class="left">Parking Charge :</td>
											<td class="right"><input type="text" readonly="readonly"  name="parkingCharge" value="<?php echo e($pcklist->parkingCharge); ?>"></td>
										</tr>
										
										<tr>
											<td class="left">Driver Cost :</td>
											<td class="right"><input type="text" readonly="readonly"  name="driverCost" value="<?php echo e($pcklist->driverCost); ?>"></td>
										</tr>
