				...
				<div class="row">
					<div class="col-lg-9" style="left: 50%;transform: translate(-50%);">
						<div class="row hcr-card hcr-right">
							...
							<span style="padding-left: 10px; padding-right: 10px; font-size: 20px;" class="text-center">Axio+10Hours Service+CNG Cost 10 Taka/kilo+Driver Cost 150 Taka</span>
							<hr>
							<div class="col-lg-12" style="border-bottom: 1px solid #bc3633; padding-bottom: 20px;">
								...
								<div class="col-lg-4 text-center">
									<span>৳ 2500</span>
									<a href="/booking/15"><button type="button" class="btn btn-primary">BOOK NOW</button></a>
								</div>
								<div class="col-lg-4">
