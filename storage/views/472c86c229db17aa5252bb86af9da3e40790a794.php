...
<body style="overflow-x: hidden;">
	...
	<div class="container-fluid">
		...
		<form method="post" action="/bookinginfoe/<?php echo e($bkngId->bookId); ?>">
							...
							<div class="well col-lg-12">
								<table align="center">
									<tr>
										<div class="col-lg-12">
											...
											<input type="text" name="StartLocation" id="input" class="form-control" value="<?php echo e($bkngId->StartLocation); ?>"" >
										</div>
									</tr>
									<tr>
										<div class="col-lg-12">
											<p style="font-size: 16px; font-family: tm; ">RETURNING LOCATION:</p>
											<input type="text" name="ReturnLocation" id="input" class="form-control" value="<?php echo e($bkngId->ReturnLocation); ?>"">
										</div>
									</tr>
										<div class="col-lg-12">
										...
										<div class="form-group">
											<div class='input-group date' id='datetimepicker1'>
												<input type='text' class="form-control" id="datetimepicker4" name="StartDateTime" value="<?php echo e($bkngId->StartDateTime); ?>"/>
								...
								<div class="form-group">
									<div class='input-group date'>
										<input type='text' class="form-control" id="datetimepicker5" name="EndDateTime" value="<?php echo e($bkngId->EndDateTime); ?>"/>
										<span class="input-group-addon">
											<i class="fas fa-calendar-alt"></i>
										</span>
									</div>
