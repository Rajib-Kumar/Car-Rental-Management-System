...
<body style="overflow-x: hidden;">
	...
	<div class="container-fluid pricing" id="pricing">
		<div class="row text-center title">
			<h1><span>EMPLOYEE INFORMATION DETAILS</span></h1>
		</div>
		<div class="row">
			<div class="container">
				<div class="row">
								...
								<div class="col-lg-7">
									<table align="center">
										...
										<tr>
											...
											<td class="right">{{$userId->status}}</td>
										</tr>
										<tr>
									...
									<a href="/employee/{{$userId->empId}}/edit"><button type="button" class="btn btn-primary" style="margin-top: 20px; width: 100px;">EDIT</button></a>
									<a href="/employee/{{$userId->empId}}/delete"><button type="button" class="btn btn-primary" style="margin-top: 20px; width: 100px;">Delete</button></a>
								</div>
								<div class="col-lg-5">
