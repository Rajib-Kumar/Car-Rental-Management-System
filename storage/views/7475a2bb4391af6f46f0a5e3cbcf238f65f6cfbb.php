					...
					<div class="col-lg-4">
						<div class="row one">
							<div class="card cardo text-center">
								...
								<div class="col-lg-12">
									<a href="dcri/1"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row one">
							<div class="card cardo text-center">
								...
								<div class="col-lg-12">
									<a href="dcri/2"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row one">
							<div class="card cardo cardo text-center">
								...
								<div class="col-lg-12">
									<a href="dcri/3"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4">
						<div class="row one">
							<div class="card cardo cardo text-center">
								...
								<div class="col-lg-12">
									<a href="dcri/4"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row one">
							<div class="card cardo cardo text-center">
								...
								<div class="col-lg-12">
									<a href="dcri/5"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row one">
							<div class="card cardo cardo text-center">
								...
								<div class="col-lg-12">
									<a href="dcri/6"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
