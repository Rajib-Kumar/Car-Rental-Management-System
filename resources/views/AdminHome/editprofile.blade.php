...
<body style="overflow-x: hidden;">
	...
	<div class="container-fluid pricing" id="pricing">
		...
		<form method="post" action="/AdminHome/{{ Session::get('user')->userId }}">
		<input type="hidden" name="aid" value="{{ Session::get('user')->userId }}">
					...
					<div class="col-lg-12">
						<div class="row booking-card">
							<div class="col-lg-6">
								...
								<input type="text" name="fname" id="input" class="form-control" value="{{$empId->firstName}}">
							</div>
							<div class="col-lg-6">
								<p style="font-size: 16px; font-family: tm;">LAST NAME:</p>
								<input type="text" name="lname" id="input" class="form-control" value="{{$empId->lastName}}">
							</div>
							<div class="col-lg-6">
								<p style="font-size: 16px; font-family: tm; margin-top: 20px;">EMAIL:</p>
								<input type="text" name="email"  id="input" class="form-control" value="{{$empId->email}}">
							</div>
							<div class="col-lg-6">
								<p style="font-size: 16px; font-family: tm; margin-top: 20px;">MOBILE NO:</p>
								<input type="text" name="mobile"  id="input" class="form-control" value="{{$empId->phone}}">
							</div>
							<div class="col-lg-6">
								<p style="font-size: 16px; font-family: tm; margin-top: 20px;">ADDRESS:</p>
								<input type="text" name="address"  id="input" class="form-control" value="{{$empId->address}}">
							</div>
							<div class="col-lg-6">
