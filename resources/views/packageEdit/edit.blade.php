...
<body style="overflow-x: hidden;">
	...
	<form method="post" action="/packages/{{$pcklist->packageId}}">
		<input type="hidden" name="pid" value="{{$pcklist->packageId}}">
								...
								<div class="col-lg-7">
									<table align="center">
										<tr>
											...
											<td class="right"><input type="text" name="packageId" value="{{$pcklist->packageId}}"></td>
										</tr>
										<tr>
											<td class="left">Package Name :</td>
											<td class="right"><input type="text" name="packageName" value="{{$pcklist->rentalType}}"></td>
										</tr>
										<tr>
											<td class="left">Package Type :</td>
											<td class="right"><input type="text" name="packageType" value="{{$pcklist->packageType}}"></td>
										</tr>
										<tr>
											<td class="left">Vehicle Type :</td>
											<td class="right"><input type="text" name="vehicleType" value="{{$pcklist->vehicleType}}"></td>
										</tr>
										<tr>
											<td class="left">Location :</td>
											<td class="right"><input type="text" name="location" value="{{$pcklist->location}}"></td>
										</tr>
										<tr>
											<td class="left">Price :</td>
											<td class="right"><input type="text" name="price" value="{{$pcklist->price}}"></td>
										</tr>
										
										<tr>
											<td class="left">Parking Charge :</td>
											<td class="right"><input type="text" name="parkingCharge" value="{{$pcklist->parkingCharge}}"></td>
										</tr>
										
										<tr>
											<td class="left">Driver Cost :</td>
											<td class="right"><input type="text" name="driverCost" value="{{$pcklist->driverCost}}"></td>
										</tr>
