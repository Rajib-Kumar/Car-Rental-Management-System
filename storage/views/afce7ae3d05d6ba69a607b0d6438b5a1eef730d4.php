				...
				<div class="row">
					<div class="col-lg-9" style="left: 50%;transform: translate(-50%);">
						<div class="row hcr-card hcr-right">
							<h3 class="text-center">X Corolla</h3>
							<span style="padding-left: 10px; padding-right: 10px; font-size: 20px;" class="text-center">X Corolla - 26 Days - 45000 Taka</span>
							<hr>
							<div class="col-lg-12" style="border-bottom: 1px solid #bc3633; padding-bottom: 20px;">
								<div class="col-lg-4">
									<img src="/images/corola.png" class="img-responsive" alt="Image" style="margin: 10px auto 0 auto;">
								</div>
								...
								<div class="col-lg-4">
									<img src="/images/corola.png" class="img-responsive flip" alt="Image" style="margin: 10px auto 0 auto;">
								</div>
							</div>
							<div class="col-lg-12">
