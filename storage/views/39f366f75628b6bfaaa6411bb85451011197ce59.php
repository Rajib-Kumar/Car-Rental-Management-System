						...
						<ul class="nav navbar-nav">
							...
							<li class="drp dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="/AdminHome/{id}">View Profile</a></li>
								...
								<div class="col-lg-7">
									<table align="center">
										<tr>
											...
											<td class="right"><?php echo e($empId->firstName); ?></td>
										</tr>
										<tr>
											<td class="left">Last Name :</td>
											<td class="right"><?php echo e($empId->lastName); ?></td>
										</tr>
										<tr>
											<td class="left">E-mail :</td>
											<td class="right"><?php echo e($empId->email); ?></td>
										</tr>
										<tr>
											<td class="left">Mobile No :</td>
											<td class="right"><?php echo e($empId->phone); ?></td>
										</tr>
										<tr>
											<td class="left">Address :</td>
											<td class="right"><?php echo e($empId->address); ?></td>
										</tr>
										<tr>
											<td class="left">City :</td>
											<td class="right"><?php echo e($empId->city); ?></td>
										</tr>
									</table>
									<a href="/AdminHome/<?php echo e(Session::get('user')->userId); ?>/edit"><button type="button" class="btn btn-primary" style="margin-top: 20px; width: 100px;">EDIT</button></a>
								</div>
								<div class="col-lg-5">
