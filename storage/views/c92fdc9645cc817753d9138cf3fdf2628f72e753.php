				...
				<div class="container">
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						<ul class="nav navbar-nav">
							...
							<li><a class="js-scroll-trigger" href="../../Home/<?php echo e(Session::get('user')->userId); ?>">Logged In As <?php echo e(Session::get('user')->userName); ?> (Admin)</a></li>
					...
					<div class="col-lg-12 contactus">
						<div class="row">
							<form action="" method="POST" role="form">
								...
								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
									<div class="row">
										<input type="email" class="form-control pull-right" required="required"  placeholder="Your Email*">
									</div>
								</div>
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="row">
										<textarea name="" id="input" class="form-control" rows="6" required="required" placeholder="Your Message*"></textarea>
									</div>
								</div>
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="row">
