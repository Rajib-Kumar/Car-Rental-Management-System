								...
								<div class="col-lg-7">
									<table align="center">
										<tr>
											...
											<td class="right">{{$userId->firstName}}</td>
										</tr>
										<tr>
											<td class="left">Last Name :</td>
											<td class="right">{{$userId->lastName}}</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td class="right">{{$userId->dob}}</td>
										</tr>
										<tr>
											<td class="left">Division :</td>
											<td class="right">{{$userId->division}}</td>
										</tr>
										<tr>
											<td class="left">City :</td>
											<td class="right">{{$userId->city}}</td>
										</tr>
										<tr>
											<td class="left">Registration Date :</td>
											<td class="right">{{$userId->regDate}}</td>
										</tr>
										<tr>
											<td class="left">User Type :</td>
											<td class="right">{{$userId->userType}}</td>
										</tr>
										<tr>
											<td class="left">User Status :</td>
											<td class="right">{{$userId->userStatus}}</td>
										</tr>
										<tr>
											<td class="left">Role :</td>
											<td class="right">{{$userId->role}}</td>
										</tr>
									</table>
									<a href="/user/{{$userId->userId}}/edit"><button type="button" class="btn btn-primary" style="margin-top: 20px; width: 100px;">EDIT</button></a>
									<a href="/user/{{$userId->userId}}/delete"><button type="button" class="btn btn-primary" style="margin-top: 20px; width: 100px;">Delete</button></a>
								</div>
								<div class="col-lg-5">
