				...
				<div class="container">
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						<ul class="nav navbar-nav">
							...
							<li><a class="js-scroll-trigger" href="/UserHome/packages">PRICING</a></li>
							<li><a class="js-scroll-trigger" href="">ABOUT US</a></li>
							<li><a class="js-scroll-trigger" href="">CONTACT US</a></li>
							<li class="dropdown">
					...
					<div class="col-lg-4">
						<div class="row one">
							<div class="card text-center">
								...
								<div class="col-lg-12">
									<a href="/packages/hcr"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row one">
							<div class="card text-center">
								...
								<div class="col-lg-12">
									<a href="/packages/dcri"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4">
						<div class="row one">
							<div class="card text-center">
								...
								<div class="col-lg-12">
									<a href="/packages/dcro"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row one">
							<div class="card text-center">
								...
								<div class="col-lg-12">
									<a href="/packages/mcr"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row one">
							<div class="card text-center">
								...
								<div class="col-lg-12">
									<a href="/packages/opd"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
