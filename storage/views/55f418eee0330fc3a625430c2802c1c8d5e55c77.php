							...
							<div class="col-lg-12">
								...
								<div class="well">
									<table align="center" class="table table-bordered" style="background-color: white;">
										...
										<?php $__currentLoopData = $bknglist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bkng): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php if($bkng->bookingStatus =="pending"): ?>
										<tr>
											<td><?php echo e($bkng->bookId); ?></td>
											<td><?php echo e($bkng->rentalType); ?></td>
											<td><?php echo e($bkng->vehicleType); ?></td>
											<td><?php echo e($bkng->bookingStatus); ?></td>
											<td><?php echo e($bkng->payingstatus); ?></td>
											<td><a href="/bookingsinfo/<?php echo e($bkng->bookId); ?>">Details</a></td>
											<td><a href="/bookingsinfo/<?php echo e($bkng->bookId); ?>/edit">Edit</a></td>
											<td><a href="/bookingsinfo/<?php echo e($bkng->bookId); ?>/delete">Delete</a></td>
