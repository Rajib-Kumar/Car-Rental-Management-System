							...
							<div class="col-lg-12">
								<table align="center" class="table table-bordered">
									...
									<tr>
										...
										<td class="text-center"><?php echo e($msg->date); ?></td>
										<td class="text-center"><?php echo e($msg->msgfrom); ?></td>
										<td class="text-center"><?php echo e($msg->role); ?></td>
										<td class="text-center"><?php echo e($msg->email); ?></td>
										<td class="text-center"><a href="/openmessage/<?php echo e($msg->id); ?>">Open</a></td>
									</tr>
