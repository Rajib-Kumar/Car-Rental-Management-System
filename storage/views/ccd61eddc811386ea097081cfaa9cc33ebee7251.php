				...
				<div class="row">
					<div class="col-lg-9" style="left: 50%;transform: translate(-50%);">
						<div class="row hcr-card hcr-right">
							<h3 class="text-center">Superior Premio</h3>
							<span style="padding-left: 10px; padding-right: 10px; font-size: 20px;" class="text-center">Superior Premio - 26 Days - 65000 Taka</span>
							<hr>
							<div class="col-lg-12" style="border-bottom: 1px solid #bc3633; padding-bottom: 20px;">
								<div class="col-lg-4">
									<img src="/images/pr3.png" class="img-responsive" alt="Image" style="margin: 10px auto 0 auto;">
								</div>
								...
								<div class="col-lg-4">
									<img src="/images/pr3.png" class="img-responsive flip" alt="Image" style="margin: 10px auto 0 auto;">
								</div>
							</div>
							<div class="col-lg-12">
								<ul class="text-justify">
									<li>Working Days:  26 days for a month considering Friday or Saturday off. </li>
									<li>Extra uses charge: After 26 days, each extra day of that month will be charged as 2000Tk/per day (Sedan)</li>
