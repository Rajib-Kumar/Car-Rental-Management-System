								...
								<div class="col-lg-7">
									<table align="center">
										...
										<tr>
											...
											<td class="right"><?php echo e($userId->status); ?></td>
										</tr>
										<tr>
									...
									<a href="/employee/<?php echo e($userId->empId); ?>/edit"><button type="button" class="btn btn-primary" style="margin-top: 20px; width: 100px;">EDIT</button></a>
									<a href="/employee/<?php echo e($userId->empId); ?>/delete"><button type="button" class="btn btn-primary" style="margin-top: 20px; width: 100px;">Delete</button></a>
								</div>
								<div class="col-lg-5">
