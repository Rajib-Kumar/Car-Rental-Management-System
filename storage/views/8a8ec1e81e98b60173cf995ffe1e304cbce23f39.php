					...
					<div class="col-lg-6">
						<div class="row booking-card">
							<div class="col-lg-12">
								...
								<input type="text" name="rentalType" readonly="readonly" id="input" class="form-control" value="<?php echo e($pckgId->rentalType); ?>">
							</div>
							<div class="col-lg-12">
								<p style="font-size: 16px; font-family: tm;">PACKAGE TYPE :</p>
								<input type="text" name="packageType" readonly="readonly" id="input" class="form-control" value="<?php echo e($pckgId->packageType); ?>">
							</div>
							<div class="col-lg-12">
								<p style="font-size: 16px; font-family: tm;">VEHICLE TYPE :</p>
								<input type="text" name="vehicleType" readonly="readonly" id="input" class="form-control" value="<?php echo e($pckgId->vehicleType); ?>">
							</div>
							<div class="col-lg-12">
								<p style="font-size: 16px; font-family: tm;">PRICE :</p>
								<input type="text" name="priceH" readonly="readonly" id="input" class="form-control" value="<?php echo e($pckgId->price); ?>">
							</div>
							<div class="col-lg-12">
								<p style="font-size: 16px; font-family: tm;">TOTAL PRICE (Including All) :</p>
								<input type="text" name="price" readonly="readonly" id="input" class="form-control" value="<?php echo e($pckgId->totalcost); ?>">
							</div>
							<div class="col-lg-12">
								<p style="font-size: 16px; font-family: tm;">Booker's Id:</p>
								<input type="text" name="uuid" readonly="readonly" id="input" class="form-control" value="<?php echo e(Session::get('user')->userId); ?>">
							</div>
							<div class="col-lg-12">
