					...
					<div class="col-lg-4">
						<div class="row one">
							<div class="card text-center">
								...
								<div class="col-lg-12">
									<a href="pricing/air-trans"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row one">
							<div class="card text-center">
								...
								<div class="col-lg-12">
									<a href="pricing/hcr"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row one">
							<div class="card text-center">
								...
								<div class="col-lg-12">
									<a href="pricing/dcri"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4">
						<div class="row one">
							<div class="card text-center">
								...
								<div class="col-lg-12">
									<a href="pricing/dcro"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row one">
							<div class="card text-center">
								...
								<div class="col-lg-12">
									<a href="pricing/mcr"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row one">
							<div class="card text-center">
								...
								<div class="col-lg-12">
									<a href="pricing/opd"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
