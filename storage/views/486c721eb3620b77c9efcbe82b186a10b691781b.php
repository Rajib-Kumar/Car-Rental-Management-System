				...
				<div class="row">
					<div class="col-lg-9" style="left: 50%;transform: translate(-50%);">
						<div class="row hcr-card hcr-right">
							...
							<span style="padding-left: 10px; padding-right: 10px; font-size: 20px;" class="text-center">Zone#3: Dhaka University, Shahbagh, New Market, Azimpur, Moghbazar, Mouchak, Malibagh, Shantinagar, Eskaton, Khilgaon, Motijheel, Kakrail, Komlapur, Basabo, Paltan, Wari, Jatrabari, Shonir Aakhra, Sadarghat, Old Town.</span>
							<hr>
