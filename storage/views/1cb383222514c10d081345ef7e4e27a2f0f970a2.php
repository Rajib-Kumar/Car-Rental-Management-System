...
<body style="overflow-x: hidden;">
	...
	<div class="container-fluid pricing" id="pricing">
		<div class="row text-center title">
			<h1><span>New User Request</span></h1>
		</div>
		<div class="row">
			<div class="container">
				<div class="row">
								...
								<div class="well">
									<table align="center" class="table table-bordered" style="background-color: white;">
										...
										<tr>
											...
											<td><a href="/user/<?php echo e($user->userId); ?>">Details</a></td>
											<td><a href="/user/<?php echo e($user->userId); ?>/edit">Edit</a></td>
											<td><a href="/user/<?php echo e($user->userId); ?>/delete">Delete</a></td>
