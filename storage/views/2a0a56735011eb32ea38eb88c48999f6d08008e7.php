				...
				<div class="row">
					<div class="col-lg-9" style="left: 50%;transform: translate(-50%);">
						<div class="row hcr-card hcr-right">
							<h3 class="text-center">Toyota Premio G Superior</h3>
							<span style="padding-left: 10px; padding-right: 10px; font-size: 20px;" class="text-center">Superior PREMIO + Fuel Cost + Driver Cost 1000 Taka/day</span>
							<hr>
							...
							<div class="col-lg-12">
								<ul class="text-justify">
									...
									<li>Fuel Cost: 8 Taka/Kilometer (CNG); 15 Taka/Kilometer (Octane). </li>
