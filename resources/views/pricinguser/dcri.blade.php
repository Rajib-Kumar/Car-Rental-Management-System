					...
					<div class="col-lg-4">
						<div class="row one">
							<div class="card cardo text-center">
								...
								<div class="col-lg-12">
									<a href="dcri/15"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row one">
							<div class="card cardo text-center">
								...
								<div class="col-lg-12">
									<a href="dcri/16"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row one">
							<div class="card cardo cardo text-center">
								...
								<div class="col-lg-6">
									<p>
										<span>৳ 3500</span><br>
										<b>Superior Allion</b> <br>
										Model: 2009-12 <br>
										10 Hours Service
									</p>
								</div>
								<div class="col-lg-6">
									<img src="dcri/3" class="img-responsive" alt="">
								</div>
								<div class="col-lg-12">
									<a href="dcri/17"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4">
						<div class="row one">
							<div class="card cardo cardo text-center">
								...
								<div class="col-lg-12">
									<a href="dcri/18"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row one">
							<div class="card cardo cardo text-center">
								...
								<div class="col-lg-12">
									<a href="dcri/19"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="row one">
							<div class="card cardo cardo text-center">
								...
								<div class="col-lg-12">
									<a href="dcri/20"><button type="button" class="btn btn-primary pull-left">View more details</button></a>
								</div>
							</div>
						</div>
					</div>
