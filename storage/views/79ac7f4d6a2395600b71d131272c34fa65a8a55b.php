				...
				<div class="row">
					<div class="col-lg-9" style="left: 50%;transform: translate(-50%);">
						<div class="row hcr-card hcr-right">
							<h3 class="text-center">Superior Allion</h3>
							<span style="padding-left: 10px; padding-right: 10px; font-size: 20px;" class="text-center">Allion Superior+10Hours Service+CNG Cost 10 Taka/kilo+Driver Cost 150 Taka</span>
							<hr>
							...
							<div class="col-lg-12">
								<ul class="text-justify">
									...
									<li>Renter has to pay the fuel cost and extra uses charge to the driver by cash.
								</ul>
							</div>
						</div>
					</div>
