...
<body style="overflow-x: hidden;">
	...
	<div class="container-fluid pricing" id="pricing">
		<div class="row text-center title">
			<h1><span>Employee SEARCH</span></h1>
		</div>
		<div class="row">
			<div class="container">
				<div class="row">
								...
								<div class="well">
									<table align="center" class="table table-bordered" style="background-color: white;">
										...
										<tr>
											...
											<td><a href="/employee/<?php echo e($emp->empId); ?>">Details</a></td>
											<td><a href="/employee/<?php echo e($emp->empId); ?>/edit">Edit</a></td>
											<td><a href="/employee/<?php echo e($emp->empId); ?>/delete">Delete</a></td>
